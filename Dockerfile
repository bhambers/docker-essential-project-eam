...
RUN wget --tries=3 --progress=bar:force:noscroll https://essential-cdn.s3.eu-west-2.amazonaws.com/viewer/essential_viewer_6188.war
...
RUN mv essential_viewer_6188.war /usr/local/tomcat/webapps/essential_viewer.war
